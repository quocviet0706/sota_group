...
/*
      ...
      if (isset($_POST["username"]) == TRUE) {
        ...
        if (count($user) > 0) {
          $md5PostPass=md5($_POST['password']);
...
<!DOCTYPE html>
<html lang="en">
<!-- Mirrored from demos.creative-tim.com/material-dashboard-pro/examples/pages/login.php by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 16 May 2019 07:46:39 GMT -->
                ...
                <div class="card-body ">
                  ...
                  <span class="bmd-form-group">
                    <div class="input-group">
                      ...
                      <input type="text" id="username" name="username" class="form-control" placeholder="First Name...">
                    </div>
                  </span>
                  <span class="bmd-form-group">
                    <div class="input-group">
  ...
  <script>
    $(document).ready(function() {
      ...
      $('#facebook').sharrre({
        ...
        url: 'https://demos.creative-tim.com/material-dashboard-pro/examples/index.php'
      });
...
<!-- Mirrored from demos.creative-tim.com/material-dashboard-pro/examples/pages/login.php by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 16 May 2019 07:46:40 GMT -->
</html> 